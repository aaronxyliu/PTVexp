...
def analyze(table_name, web_num_limit=1000000):
    ...
    logger.info(y2015dist.freqDict('Libraries Released in 2024'))
...
if __name__ == '__main__':
    # Usage: python3 analyze/lib_date_dist.py result04 1000       Analyze the table 'table03' and take the front 1000 websites
    if len(sys.argv) == 1:
