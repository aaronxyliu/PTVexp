...
WEBSITE_RANK_RANGE = (25 * 10000, 30 * 10000)
SUFFIX = '300k'
...
def analyze(table_name, lib_blacklist):
    ...
    logger.custom('mean', freq_dist.mean(processFunc=lambda x:x[0]))
    logger.custom('variance', freq_dist.variance(processFunc=lambda x:x[0]))
